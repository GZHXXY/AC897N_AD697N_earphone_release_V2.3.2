#ifndef CONFIG_BOARD_AD6973A_ANC_CFG_H
#define CONFIG_BOARD_AD6973A_ANC_CFG_H

#ifdef CONFIG_BOARD_AD6973A_ANC

#define BOARD_DEVELOP_MODE		0	/*开发板开发模式*/
...
#if BOARD_DEVELOP_MODE
#define TCFG_UART0_TX_PORT  				IO_PORTA_05                             //串口发送脚配置
#else
#define TCFG_UART0_TX_PORT  				IO_PORTC_00                             //串口发送脚配置
#endif
...
//                                 aec 工具在线调试
//*********************************************************************************//
#define TCFG_AEC_TOOL_ONLINE_ENABLE               0
#if (TCFG_AEC_TOOL_ONLINE_ENABLE && (TCFG_ONLINE_ENABLE == 0))//aec 在线调试打开时，默认打开 普通串口调试,串口是 TCFG_ONLINE_TX_PORT, TCFG_ONLINE_RX_PORT,波特率115200
...
#endif //CONFIG_BOARD_AD6973A_ANC
#endif //CONFIG_BOARD_AD6973A_ANC_CFG_H
