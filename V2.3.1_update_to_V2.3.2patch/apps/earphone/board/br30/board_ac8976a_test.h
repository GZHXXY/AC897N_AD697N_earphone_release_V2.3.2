#ifndef CONFIG_BOARD_AC8976A_TEST_CFG_H
#define CONFIG_BOARD_AC8976A_TEST_CFG_H

#ifdef CONFIG_BOARD_AC8976A_TEST

#define CONFIG_SDFILE_ENABLE
#define CONFIG_FLASH_SIZE       (1024 * 1024)
#define CONFIG_CHIP_NAME        AC897N
...
#define TCFG_AUDIO_PLNK_DAT0_PIN			IO_PORTA_05
#define TCFG_AUDIO_PLNK_DAT1_PIN			IO_PORTA_06
/*MIC LDO电流档位设置：
...
#define TCFG_AUDIO_ANC_ENABLE				0//ANC_RUN_MODE
#define TCFG_ANC_TOOL_DEBUG_ONLINE 			0//ENABLE_THIS_MOUDLE//ANC工具蓝牙spp调试
/*
 *ANC模式下，如果想要音频的音量比ANC的音量大，可以设置这个宏
 *0表示音频音量和ANC音量相同
 */
#define TCFG_AUDIO_ANC_DYNAMIC_DAC_GAIN		0	//12
/*
 ...
 */
#if TCFG_AUDIO_ANC_ENABLE
#define TCFG_CALL_USE_DIGITAL_VOLUME		0//ENABLE_THIS_MOUDLE
#else
#define TCFG_CALL_USE_DIGITAL_VOLUME		ENABLE_THIS_MOUDLE
#endif
 ...
 *(2)选择mic vdd对应的port
 */
#define TCFG_AUDIO_MIC_PWR_CTL				ENABLE_THIS_MOUDLE
...
#define TCFG_WAV_TONE_MIX_ENABLE			ENABLE   //wav提示音叠加播放
...
/*通话下行降噪使能*/
#define TCFG_ESCO_DL_NS_ENABLE				ENABLE_THIS_MOUDLE

// AUTOMUTE
#define AUDIO_OUTPUT_AUTOMUTE   			DISABLE_THIS_MOUDLE

//低音增强功能
#define TCFG_AUDIO_BASS_BOOST  				DISABLE_THIS_MOUDLE
...
#define TCFG_TEST_BOX_ENABLE			    1                         //是否支持蓝牙测试盒
#if TCFG_AUDIO_ANC_ENABLE
...
//是否支持拔出充电自动开机功能
#define TCFG_CHARGE_OFF_POWERON_NE		1//	DISABLE
/*
充电截止电压可选配置：
...
#define TCFG_LOWPOWER_VDDIO_KEEP            0       //软关机是否保持VDDIO 电压
...
#define TCFG_DRC_ENABLE  						  ENABLE_THIS_MOUDLE//低音增强需要开启DRC
#endif
#define TCFG_AUDIO_MDRC_ENABLE   				  ENABLE_THIS_MOUDLE//使能DRC子模块：MDRC
...
#define TCFG_USER_BLE_ENABLE                      0   //双模工程，默认打开BLE功能使能
#else
#define TCFG_USER_BLE_ENABLE                      1   //BLE功能使能
#endif
#define TCFG_BT_SUPPORT_AAC                       1   //AAC格式支持
#define TCFG_BT_SUPPORT_G729                      DISABLE   //G729格式支持
#define TCFG_DEC_WTGV2_ENABLE				      ENABLE	//WTS格式支持
 ...
 *3、ANC工具蓝牙spp调试
 */
#if (TCFG_AEC_TOOL_ONLINE_ENABLE || TCFG_AUDIO_DMS_DUT_ENABLE || TCFG_ANC_TOOL_DEBUG_ONLINE)
#undef USER_SUPPORT_PROFILE_SPP
...
//串口在线调音时，解除相关模块的占用
#if TCFG_SYS_LVD_EN && TCFG_EQ_ONLINE_ENABLE
#undef TCFG_SYS_LVD_EN
#define TCFG_SYS_LVD_EN 0
#endif
#if TCFG_ONLINE_ENABLE && TCFG_EQ_ONLINE_ENABLE
...
#endif //CONFIG_BOARD_AC8976A_ANC
#endif //CONFIG_BOARD_AC8976A_ANC_CFG_H
