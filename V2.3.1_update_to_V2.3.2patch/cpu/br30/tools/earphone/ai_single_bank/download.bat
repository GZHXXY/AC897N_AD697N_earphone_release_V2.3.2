...
..\..\isd_download.exe isd_config_%1.ini -tonorflash -dev br30 -boot 0x2000 -div8 -wait 300 -uboot ..\..\uboot.boot -app app.bin  -res cfg_tool.bin  tone.cfg config.dat ..\..\p11_code.bin ..\..\eq_cfg_hw.bin md5.bin -uboot_compress
