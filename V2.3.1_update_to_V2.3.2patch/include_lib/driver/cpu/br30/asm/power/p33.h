...
#define P3_ANA_CON0                       P33_ACCESS(0x00)
#define P3_ANA_CON1                       P33_ACCESS(0x01)
#define P3_ANA_CON2                       P33_ACCESS(0x02)
#define P3_ANA_CON3                       P33_ACCESS(0x03)
#define P3_ANA_CON4                       P33_ACCESS(0x04)
#define P3_ANA_CON5                       P33_ACCESS(0x05)
#define P3_ANA_CON6                       P33_ACCESS(0x06)
#define P3_ANA_CON7                       P33_ACCESS(0x07)
#define P3_ANA_CON8                       P33_ACCESS(0x08)
#define P3_ANA_CON9                       P33_ACCESS(0x09)
#define P3_ANA_CON10                      P33_ACCESS(0x0a)
#define P3_ANA_CON11                      P33_ACCESS(0x0b)
#define P3_ANA_CON12                      P33_ACCESS(0x0c)
#define P3_ANA_CON13                      P33_ACCESS(0x0d)
#define P3_ANA_CON14                      P33_ACCESS(0x0e)
#define P3_ANA_CON15                      P33_ACCESS(0x0f)
...
#define P3_ANA_LAT                        P33_ACCESS(0x18)
...
//............. 0x0090 - 0x009f............ for PORT

//#define P3_PR_IN                          P33_ACCESS(0x98)
//#define P3_PR_OUT                         P33_ACCESS(0x99)
//#define P3_PR_DIR                         P33_ACCESS(0x9a)
//#define P3_PR_DIE                         P33_ACCESS(0x9b)
//#define P3_PR_PU                          P33_ACCESS(0x9c)
//#define P3_PR_PD                          P33_ACCESS(0x9d)
//#define P3_PR_HD                          P33_ACCESS(0x9e)
...
#define RVDD_SHORT_EN(en)       P33_CON_SET(P3_ANA_CON1, 1, 1, en)

#define SVDD_SHORT_EN(en)       P33_CON_SET(P3_ANA_CON1, 2, 1, en)

#define WLDO06_EN(en)           P33_CON_SET(P3_ANA_CON1, 3, 1, en)

#define PVD_SHORT_PB3(en)       P33_CON_SET(P3_ANA_CON1, 4, 1, en)

#define EVD_SHORT_PB3(en)       P33_CON_SET(P3_ANA_CON1, 5, 1, en)

#define EVD_EN(en)       		P33_CON_SET(P3_ANA_CON1, 6, 1, en)

#define WVDDIO_FBRES_SEL_W(en)  P33_CON_SET(P3_ANA_CON1, 7, 1, en)
/*******************************************************************/
...
#define VDDOK_OE(en)          	P33_CON_SET(P3_ANA_CON2, 4, 1, en)

#define VDDOK_EN(en)          	P33_CON_SET(P3_ANA_CON2, 5, 1, en)

#define PVDDOK_OE(en)       	P33_CON_SET(P3_ANA_CON2, 6, 1, en)

#define PVDDOK_EN(en)       	P33_CON_SET(P3_ANA_CON2, 7, 1, en)
/*******************************************************************/
...
#define PMU_DET_BG_BUF_EN(en)   P33_CON_SET(P3_ANA_CON4, 0, 5, en)
/*******************************************************************/
 ...
 *-------------------P3_ANA_CON14
 */
#define EVD_VOL_SEL(sel)       P33_CON_SET(P3_ANA_CON14, 2, 2, sel)
#define PVD_HD_L_SEL(sel)      P33_CON_SET(P3_ANA_CON14, 0, 2, sel)
...
#define RC32K_RNPS_SEL(sel)     P33_CON_SET(P3_LRC_CON0, 7, 1, (sel & BIT(0))); \
...
#define CLOCK_KEEP(a)       \
    if (a) {    \
        ...
        p33_and_1byte(P3_VLD_KEEP, ~BIT(0)); \
    }


#define RTC_WKUP_KEEP(a)        \
    if (a) {    \
        p33_or_1byte(P3_VLD_KEEP, BIT(1)); \
    } else { \
        p33_and_1byte(P3_VLD_KEEP, ~BIT(1)); \
    }

#define WKUP_OUT_EN(a)          \
    if (a) {    \
...
#ifdef CONFIG_BR30_C_VERSION
#define WVDDIO_FBRES_AUTO(a)  \
    if (a) {    \
        p33_or_1byte(P3_VLD_KEEP, BIT(3)); \
    } else { \
        p33_and_1byte(P3_VLD_KEEP, ~BIT(3)); \
    }
#endif
/*****************************************************************/
