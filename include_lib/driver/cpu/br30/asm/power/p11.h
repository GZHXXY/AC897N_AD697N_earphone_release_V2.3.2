...
#define P2M_R3_WKUP_SRC				P11_P2M_ACCESS(15)
#define P2M_R3_ALM_CON				P11_P2M_ACCESS(16)
#define P2M_R3_TIME_PND				P11_P2M_ACCESS(17)
#define P2M_CTMU_CTMU_WKUP_MSG		P11_P2M_ACCESS(18)
#define P2M_REPLY_COMMON_CMD        P11_P2M_ACCESS(19)
...
#define M2P_CTMU_CH1_TRIM_VALUE_L   		P11_M2P_ACCESS(37)
#define M2P_CTMU_CH1_TRIM_VALUE_H   		P11_M2P_ACCESS(38)
#define M2P_CTMU_CH1_RES_SEND       		P11_M2P_ACCESS(39)



#define M2P_RTC_CMD							P11_M2P_ACCESS(40)
#define M2P_RTC_DAT0						P11_M2P_ACCESS(41)
#define M2P_RTC_DAT1						P11_M2P_ACCESS(42)
#define M2P_RTC_DAT2						P11_M2P_ACCESS(43)
#define M2P_RTC_DAT3						P11_M2P_ACCESS(44)
#define M2P_RTC_DAT4						P11_M2P_ACCESS(45)
//FOR LPCTMU LONG CLICK RESET
#define M2P_LCTM_RESET_PCNT_PRD0			P11_M2P_ACCESS(46)
#define M2P_LCTM_RESET_PCNT_PRD1			P11_M2P_ACCESS(47)
#define M2P_LCTM_RESET_PCNT_VALUE			P11_M2P_ACCESS(48)
#define M2P_COMMON_CMD            			P11_M2P_ACCESS(49)
#define M2P_CTM_INEAR_VALUE_L               P11_M2P_ACCESS(50)
#define M2P_CTM_INEAR_VALUE_H               P11_M2P_ACCESS(51)
#define M2P_CTM_OUTEAR_VALUE_L               P11_M2P_ACCESS(52)
#define M2P_CTM_OUTEAR_VALUE_H               P11_M2P_ACCESS(53)
#define M2P_CTMU_CH0_RES_SEND       		P11_M2P_ACCESS(54)
#define M2P_VDDIO_KEEP_TYPE                 P11_M2P_ACCESS(55)
