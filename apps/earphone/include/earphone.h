...
int tme_event_handler(struct sys_event *event);

#define EARPHONE_STATE_INIT()                   tme_earphone_state_init()
#define EARPHONE_STATE_SET_PAGE_SCAN_ENABLE()   tme_earphone_state_set_page_scan_enable()
#define EARPHONE_STATE_GET_CONNECT_MAC_ADDR()   tme_earphone_state_get_connect_mac_addr()
#define EARPHONE_STATE_CANCEL_PAGE_SCAN()       tme_earphone_state_cancel_page_scan()
#define EARPHONE_STATE_ENTER_SOFT_POWEROFF()    tme_earphone_state_enter_soft_poweroff()
#define EARPHONE_STATE_TWS_INIT(a)              tme_earphone_state_tws_init(a)
#define EARPHONE_STATE_TWS_CONNECTED(a, b)      tme_earphone_state_tws_connected(a,b)
#define SYS_EVENT_HANDLER_SPECIFIC(a)           tme_sys_event_handler_specific(a)
#define SYS_EVENT_REMAP(a) 				        tme_event_handler(a)
#define EARPHONE_STATE_SNIFF(a)
#define EARPHONE_STATE_ROLE_SWITCH(a)
...
#define EARPHONE_STATE_INIT()                   mma_earphone_state_init()
#define EARPHONE_STATE_SET_PAGE_SCAN_ENABLE()   mma_earphone_state_set_page_scan_enable()
#define EARPHONE_STATE_GET_CONNECT_MAC_ADDR()   mma_earphone_state_get_connect_mac_addr()
#define EARPHONE_STATE_CANCEL_PAGE_SCAN()       mma_earphone_state_cancel_page_scan()
#define EARPHONE_STATE_ENTER_SOFT_POWEROFF()    mma_earphone_state_enter_soft_poweroff()
#define EARPHONE_STATE_TWS_INIT(a)              mma_earphone_state_tws_init(a)
#define EARPHONE_STATE_TWS_CONNECTED(a, b)      mma_earphone_state_tws_connected(a,b)
#define SYS_EVENT_HANDLER_SPECIFIC(a)           mma_sys_event_handler_specific(a)
#define SYS_EVENT_REMAP(a) 				        mma_event_handler(a)
#define EARPHONE_STATE_SNIFF(a)
#define EARPHONE_STATE_ROLE_SWITCH(a)

#elif NECM_EN
int necm_earphone_state_init();
#define EARPHONE_STATE_INIT()                   necm_earphone_state_init()
#define EARPHONE_STATE_SET_PAGE_SCAN_ENABLE()   necm_earphone_state_set_page_scan_enable()
#define EARPHONE_STATE_GET_CONNECT_MAC_ADDR()   necm_earphone_state_get_connect_mac_addr()
#define EARPHONE_STATE_CANCEL_PAGE_SCAN()       necm_earphone_state_cancel_page_scan()
#define EARPHONE_STATE_ENTER_SOFT_POWEROFF()    necm_earphone_state_enter_soft_poweroff()
#define EARPHONE_STATE_TWS_INIT(a)              necm_earphone_state_tws_init(a)
#define EARPHONE_STATE_TWS_CONNECTED(a, b)      necm_earphone_state_tws_connected(a,b)
#define SYS_EVENT_HANDLER_SPECIFIC(a)           necm_sys_event_handler_specific(a)
#define SYS_EVENT_REMAP(a) 				        0
#define EARPHONE_STATE_SNIFF(a)
#define EARPHONE_STATE_ROLE_SWITCH(a)
#else
