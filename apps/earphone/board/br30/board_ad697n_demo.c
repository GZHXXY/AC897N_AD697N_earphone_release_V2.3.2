...
u8 key_table_l[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_MUSIC_NEXT,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_MUSIC_NEXT,     KEY_MUSIC_PREV},   //KEY_0
...
#include "uart_update.h"
            ...
            y_printf(">>>[test]:uart1 update init\n");
...
#endif /* #ifdef CONFIG_BOARD_AD697N_DEMO */
