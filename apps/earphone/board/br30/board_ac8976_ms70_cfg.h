#ifndef CONFIG_BOARD_AC8976_MS70_CFG_H
#define CONFIG_BOARD_AC8976_MS70_CFG_H

#ifdef CONFIG_BOARD_AC8976_MS70
...
#define TCFG_SDX_CAN_OPERATE_MMC_CARD       2
...
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTB_02        //IO按键端口

#define TCFG_IOKEY_PREV_CONNECT_WAY		    ONE_PORT_TO_LOW    //按键一端接低电平一端接IO
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTB_03        //IO按键端口
...
#if TCFG_SD0_ENABLE
#define TCFG_BT_SNIFF_DISABLE                     1
#define TCFG_DEC_MP3_ENABLE                       1
