#ifndef CONFIG_BOARD_AC8976A_NPU_CFG_H
#define CONFIG_BOARD_AC8976A_NPU_CFG_H

#ifdef CONFIG_BOARD_AC8976A_NPU
...
#define TCFG_EARIN_TOUCH_KEY_SENSITIVITY 		8 	//触摸按键电容检测灵敏度配置(级数0 ~ 9)
...
//                                 GX8002_NPU配置                                  //
//*********************************************************************************//
#define TCFG_GX8002_NPU_ENABLE 			ENABLE_THIS_MOUDLE
#define TCFG_GX8002_NPU_INT_PORT 		IO_PORTA_07
#define TCFG_GX8002_NPU_UART_TX_PORT 	IO_PORTC_02
#define TCFG_GX8002_NPU_UART_RX_PORT 	IO_PORTC_03
...
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTA_02
...
#define TCFG_PWMLED_PIN						IO_PORTA_06//LED使用的IO口
//*********************************************************************************//
//                                  时钟配置                                       //
//*********************************************************************************//
...
#define TCFG_AUDIO_OUT_EQ_ENABLE                  1     //mix out级，增加eq高低音接口
...
#endif /* #ifndef CONFIG_BOARD_AC8976A_NPU */
#endif /* #ifndef CONFIG_BOARD_AC8976A_NPU_CFG_H */
