...
#endif
    audio_codec_clock_del(AUDIO_KTONE_MODE);
...
#endif
    audio_codec_clock_set(AUDIO_KTONE_MODE, AUDIO_CODING_PCM, 0);
...
/*
*********************************************************************
*                  Audio Key Tone Idle Query
* Description:提示音idle判断
* Arguments  : volume		音量
* Return	 : 1: idle   0:busy
* Note(s)    : None.
*********************************************************************
*/
static u8 audio_key_tone_idle_query()
{
...
REGISTER_LP_TARGET(audio_key_tone_lp_target) = {
    .name = "audio_key_tone",
    .is_idle = audio_key_tone_idle_query,
};


#endif//TCFG_KEY_TONE_EN
